/**
  ...
  *
  * @apiError {String} field:token token isn't specified
  * @apiError {String} field:repository repository name isn't specified
  * @apiError {String} field:key key name related to configuration isn't specified
  *

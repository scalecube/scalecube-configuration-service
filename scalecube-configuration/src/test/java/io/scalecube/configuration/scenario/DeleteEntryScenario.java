...
public class DeleteEntryScenario extends BaseScenario {
  ...
  void deleteEntry(
    ...
    StepVerifier.create(
            configurationService
                ...
                .then(
                    configurationService.readEntry(new ReadEntryRequest(adminToken, repoName, entryKey2))))
  ...
  void deleteEntryWithIdenticalKey(
    ...
    configurationService
        ...
        .then(configurationService.createEntry(new CreateOrUpdateEntryRequest(token, repoName2, entryKey, entryValue2)))
        .block(TIMEOUT);
  ...
  void deleteEntryByMember(
    ...
    StepVerifier.create(
            configurationService
                ...
                .then(
                    configurationService.readEntry(new ReadEntryRequest(memberToken, repoName, entryKey))))
  ...
  void deleteNonExistingEntryByAdmin(
    ...
    StepVerifier.create(
            configurationService
                ...
                .then(configurationService.readEntry(new ReadEntryRequest(adminToken, repoName, entryKey))))

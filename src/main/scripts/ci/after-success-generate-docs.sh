...
SCALECUBE_CF_SERVICE_DOCS='/tmp/scalecube-repo/configuration-service/'
...
mkdir -p /tmp/docs-generated $SCALECUBE_CF_SERVICE_DOCS && rm -rf $SCALECUBE_CF_SERVICE_DOCS*
...
cp -R /tmp/docs-generated/* $SCALECUBE_CF_SERVICE_DOCS

cd $SCALECUBE_CF_SERVICE_DOCS && \
    git add . && \
